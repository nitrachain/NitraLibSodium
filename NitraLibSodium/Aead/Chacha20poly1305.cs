    ...
    public unsafe partial class Chacha20poly1305
    {
        ...
        public static int IetfEncrypt(byte[] c, ref ulong clen_p, byte[] m, ulong mlen, byte[] ad, ulong adlen, byte[] nsec, byte[] npub, byte[] k)
        {
            fixed (ulong* __refParamPtr1 = &clen_p)
            {
                ...
                var __ret = __Internal.IetfEncrypt(MarshalHelper.ByteArrayToIntPtr(c), __arg1, MarshalHelper.ByteArrayToIntPtr(m), mlen, MarshalHelper.ByteArrayToIntPtr(ad),
                    adlen, MarshalHelper.ByteArrayToIntPtr(nsec), MarshalHelper.ByteArrayToIntPtr(npub), MarshalHelper.ByteArrayToIntPtr(k));
                return __ret;
            }
        }
        ...
        public static int IetfEncryptDetached(byte[] c, byte[] mac, ref ulong maclen_p, byte[] m, ulong mlen, byte[] ad, ulong adlen, byte[] nsec, byte[] npub, byte[] k)
        {
            fixed (ulong* __refParamPtr2 = &maclen_p)
            {
                ...
                var __ret = __Internal.IetfEncryptDetached(MarshalHelper.ByteArrayToIntPtr(c), MarshalHelper.ByteArrayToIntPtr(mac), __arg2, MarshalHelper.ByteArrayToIntPtr(m), mlen,
                    MarshalHelper.ByteArrayToIntPtr(ad), adlen, MarshalHelper.ByteArrayToIntPtr(nsec), MarshalHelper.ByteArrayToIntPtr(npub), MarshalHelper.ByteArrayToIntPtr(k));
                return __ret;
            }
        }
        ...
        {
            var __ret = __Internal.IetfDecryptDetached(MarshalHelper.ByteArrayToIntPtr(m), MarshalHelper.ByteArrayToIntPtr(nsec), MarshalHelper.ByteArrayToIntPtr(c), 
        ...
        public static int Encrypt(byte[] c, ref ulong clen_p, byte[] m, ulong mlen, byte[] ad, ulong adlen, byte[] nsec, byte[] npub, byte[] k)
        {
            ...
            {
                var __arg1 = __refParamPtr1;
                var __ret = __Internal.Encrypt(MarshalHelper.ByteArrayToIntPtr(c), __arg1, MarshalHelper.ByteArrayToIntPtr(m), mlen, MarshalHelper.ByteArrayToIntPtr(ad), 
                    adlen, MarshalHelper.ByteArrayToIntPtr(nsec), MarshalHelper.ByteArrayToIntPtr(npub), MarshalHelper.ByteArrayToIntPtr(k));
                return __ret;
            }
        }
        ...
        {
            var __ret = __Internal.DecryptDetached(MarshalHelper.ByteArrayToIntPtr(m), MarshalHelper.ByteArrayToIntPtr(nsec), MarshalHelper.ByteArrayToIntPtr(c), clen,
                MarshalHelper.ByteArrayToIntPtr(mac), MarshalHelper.ByteArrayToIntPtr(ad), adlen, MarshalHelper.ByteArrayToIntPtr(npub), MarshalHelper.ByteArrayToIntPtr(k));
            return __ret;
        }
